...
const (
	SocialService_FollowAction_FullMethodName     = "/pb.SocialService/FollowAction"
	SocialService_IsFollow_FullMethodName         = "/pb.SocialService/IsFollow"
	SocialService_GetFollowList_FullMethodName    = "/pb.SocialService/GetFollowList"
	SocialService_GetFollowerList_FullMethodName  = "/pb.SocialService/GetFollowerList"
	SocialService_GetFriendList_FullMethodName    = "/pb.SocialService/GetFriendList"
	SocialService_GetFollowCount_FullMethodName   = "/pb.SocialService/GetFollowCount"
	SocialService_GetFollowerCount_FullMethodName = "/pb.SocialService/GetFollowerCount"
	SocialService_PostMessage_FullMethodName      = "/pb.SocialService/PostMessage"
	SocialService_GetMessage_FullMethodName       = "/pb.SocialService/GetMessage"
)
...
func (c *socialServiceClient) IsFollow(ctx context.Context, in *IsFollowRequest, opts ...grpc.CallOption) (*IsFollowResponse, error) {
	...
	err := c.cc.Invoke(ctx, SocialService_IsFollow_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *socialServiceClient) GetFollowCount(ctx context.Context, in *FollowCountRequest, opts ...grpc.CallOption) (*FollowCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, SocialService_GetFollowCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *socialServiceClient) GetFollowerCount(ctx context.Context, in *FollowCountRequest, opts ...grpc.CallOption) (*FollowerCountResponse, error) {
	...
	err := c.cc.Invoke(ctx, SocialService_GetFollowerCount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SocialService_IsFollow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SocialService_IsFollow_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SocialService_GetFollowCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SocialService_GetFollowCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
